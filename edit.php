...
if ($result1->num_rows) {
    ...
    $img = $row1["image"];
    echo '<form action="editchanges.php" method="post" enctype="multipart/form-data" onsubmit="return validateOnSubmit()">';
    ...
    echo '<p style="top:38px;left:180px;">Proflie Image</p><pre><input type="file" name="image" onmouseover="pointerCursor(this)"></pre></div>';
    ...
    echo '<button type="submit" onmouseover="pointerCursor(this)">Submit</input></form>';
}
